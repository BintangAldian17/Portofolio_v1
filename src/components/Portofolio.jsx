        ...
        <div className=" flex flex-col gap-y-10 w-full h-full  overflow-x-auto">
          ...
          <div className=" w-full h-full items-center gap-x-10 overscroll-auto grid grid-flow-col max-w-full">
            {data.card.map((e) => {
              ...
              return (
                <div
                  className=" lg:w-96 lg:h-96 rounded-xl bg-[#faf7f7] border-2 border-gray-500 flex flex-col shadow-gray-500 shadow-[7px_8px_1px_0]  overflow-hidden"
                  key={e.id}>
                  ...
                  <div className=" h-[60%] w-full overflow-hidden object-cover group cursor-pointer relative">
                    <img
                      src={e.img}
                      alt=""
                      className=" w-full h-full object-cover hover:scale-110 transition-all ease-in-out duration-300"
                    />
                    <div className=" w-full h-full bg-gradient-to-t absolute from-black to-transparent"></div>
                  </div>
                  <div className=" h-[30%] w-full px-2 pt-2">
                    <h1 className=" text-4xl drop-shadow text-neutral-900 font-bold font-Geologica">{e.desc}</h1>
                  </div>
                </div>
              );
            })}
